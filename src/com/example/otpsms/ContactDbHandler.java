...
public class ContactDbHandler extends SQLiteOpenHelper {
    ...
    Contact getContact(int id) {
        ...
        Contact tlf = new Contact(Integer.parseInt(cursor.getString(0)),
        				cursor.getString(1), 
        				cursor.getString(2),
        				cursor.getString(3));
    ...
    public List<Contact> getAllScores() {
    ...
    // Updating single tlf
    public int updateContact(Contact tlf) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    // Deleting single tlf
    public void deleteContact(Contact tlf) {
        SQLiteDatabase db = this.getWritableDatabase();
